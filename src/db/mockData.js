...
export const INITIAL_CHART_OF_ACCOUNTS = [
  ...
  { code: '610301', name: '油桶', type: 'expense', parentCode: '6103', desc: '油桶加油費用' },
  { code: '610302', name: '塑膠車 PKA-7032（淺藍）', type: 'expense', parentCode: '6103', desc: '塑膠車 PKA-7032 加油費用' },
  { code: '610303', name: '檔車（紅色）', type: 'expense', parentCode: '6103', desc: '紅色檔車加油費用' },
  { code: '610304', name: '檔車（藍色）', type: 'expense', parentCode: '6103', desc: '藍色檔車加油費用' },
  { code: '610305', name: '發財車 BBR-7931', type: 'expense', parentCode: '6103', desc: '發財車 BBR-7931 加油費用' },
  { code: '610306', name: '發財車 5417-J8', type: 'expense', parentCode: '6103', desc: '發財車 5417-J8 加油費用' },
  { code: '6104', name: '車輛折舊與維修', type: 'expense', desc: '貨車牌照、檢驗、損耗修繕' },
  { code: '6105', name: '水電瓦斯與電信', type: 'expense', desc: '水費、電費、店內瓦斯、電話費' },
  { code: '610501', name: '水費', type: 'expense', parentCode: '6105', desc: '營業場所水費' },
  { code: '610502', name: '電費', type: 'expense', parentCode: '6105', desc: '營業場所電費' },
  { code: '610503', name: '電話費', type: 'expense', parentCode: '6105', desc: '營業電話費' },
  { code: '610504', name: '網路費', type: 'expense', parentCode: '6105', desc: '營業場所網路費' },
  { code: '6106', name: '雜項支出', type: 'expense', desc: '文具、清潔用品及其他零星支出' },
  { code: '6107', name: '專業服務費', type: 'expense', desc: '會計、記帳及其他專業服務費' },
  { code: '610701', name: '記帳費', type: 'expense', parentCode: '6107', desc: '會計與記帳服務費' },
  { code: '6108', name: '交際費', type: 'expense', desc: '營業交際與禮金支出' },
  { code: '610801', name: '禮金', type: 'expense', parentCode: '6108', desc: '營業相關禮金支出' },
  { code: '6109', name: '稅捐', type: 'expense', desc: '營業相關稅捐' },
  { code: '610901', name: '營業稅', type: 'expense', parentCode: '6109', desc: '營業稅支出' },
  { code: '610902', name: '營利事業所得稅', type: 'expense', parentCode: '6109', desc: '營利事業所得稅支出' },
  { code: '6110', name: '股東分紅', type: 'expense', desc: '股東盈餘分配' },
  { code: '611001', name: '曄鏵', type: 'expense', parentCode: '6110', desc: '曄鏵股東分紅' },
  { code: '611002', name: '子毛', type: 'expense', parentCode: '6110', desc: '子毛股東分紅' },
  { code: '611003', name: '小龍', type: 'expense', parentCode: '6110', desc: '小龍股東分紅' },
  { code: '6111', name: '飯鍋', type: 'expense', desc: '營業用飯鍋設備或採購支出' },
  { code: '611101', name: '輝力 30 人飯鍋', type: 'expense', parentCode: '6111', desc: '輝力 30 人份飯鍋' },
  { code: '611102', name: '林內 50 人飯鍋', type: 'expense', parentCode: '6111', desc: '林內 50 人份飯鍋' },
  { code: '6112', name: '員工福利', type: 'expense', desc: '員工福利、聚餐、制服及相關支出' }
];
